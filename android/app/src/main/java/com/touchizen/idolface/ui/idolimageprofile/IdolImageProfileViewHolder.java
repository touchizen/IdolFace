...
public class IdolImageProfileViewHolder extends RecyclerView.ViewHolder {
    public static final String TAG = IdolImageProfileViewHolder.class.getSimpleName();
    ...
    public IdolImageProfileViewHolder(@NonNull View itemView) {
        super(itemView);
    }

    public IdolImageProfileViewHolder(View view, final OnClickListener onClickListener, Activity activity) {
        this(view, onClickListener, activity, true);
    }

    public IdolImageProfileViewHolder(
            View view,
