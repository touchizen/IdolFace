...
public final class ShareUtils {
    ...
    public static void shareScreenshot(@NonNull final AppCompatActivity activity,@NonNull final Fragment fragment){
        //View rootView = activity.getWindow().getDecorView(); for Activity
        View rootView = fragment.getView();
        shareBitmap(activity, BitmapUtils.screenShot(rootView));
    }

    @SuppressWarnings("ResultOfMethodCallIgnored")
    public static void shareBitmap(@NonNull final Context context, @NonNull final Bitmap bitmap) {
        //---Save bitmap to external cache directory---//
        //get cache directory
        File cachePath = new File(context.getExternalCacheDir(), "my_share/");
        cachePath.mkdirs();

        //create png file
        File file = new File(cachePath, "idolface.png");
