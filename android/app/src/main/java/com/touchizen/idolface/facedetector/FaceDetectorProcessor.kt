...
package com.touchizen.idolface.facedetector
...
class FaceDetectorProcessor(context: Context, detectorOptions: FaceDetectorOptions?) :
  ...
  private var isFaceVisible: Boolean = false
  init {
  ...
  public fun setFaceVisible(enable: Boolean) {
   this.isFaceVisible = enable
  }

  public fun setOnFaceDetectListener(fdl : OnFaceDetectListener ) {
    faceDetectListener = fdl
  }
