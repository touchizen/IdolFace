...
import com.touchizen.idolface.databinding.FragmentLicensesBinding;
import com.touchizen.idolface.databinding.ItemSoftwareComponentBinding;
...
public class LicenseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater,
        ...
        binding.memberReadLicense.setOnClickListener(v -> {
            activeLicense = StandardLicenses.MEMBER;
            compositeDisposable.add(LicenseFragmentHelper.showLicense(getActivity(),
